window.addEventListener('DOMContentLoaded', function() {
    ...
    new MenuCard(
        ...
        "post",
        'Меню "Постное"',
        'Меню "Постное" - это тщательный подбор ингредиентов: полное отсуствие продуктов животного происхождения,'+
        ' молоко из миндаля, овса, кокоса или гречки, привильное количество белков за счет тофу и импортных '+
        'вегетарианских стайков.',
        14,
        ".menu .container"
    ).render();
    ...
    function showThanksModal(message) {
        ...
        thanksModal.classList.add('madal__dialog');
